...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="bg-white py-[120px] relative overflow-hidden">
      <BTPBlueprint3D opacity={0.08} intensity={0.5} className="z-0" />
      <div className="max-w-[1280px] mx-auto px-10">
        ...
        <div className="grid grid-cols-2 gap-[80px] items-start mb-[100px] about-header">
          <div>
            ...
            <h2 className="reveal font-['Cormorant_Garamond'] font-semibold text-[--navy] leading-[1.1]" style={{ fontSize:"clamp(36px,5vw,56px)" }}>
              Qui Sommes-nous&nbsp;?
            </h2>
          </div>
          <div className="reveal pt-3">
            <div className="w-14 h-[2px] bg-[--gold] mb-7" />
            <p className="font-['DM_Sans'] text-[17px] leading-[1.8] text-[#4a5568] mb-6 text-justify">
            ...
            <p className="font-['DM_Sans'] text-[16px] leading-[1.8] text-[#718096] text-justify">
        ...
        >
          ...
          >
            ...
            <h3 className="font-['Cormorant_Garamond'] text-[36px] font-semibold text-white mb-6 leading-[1.2]">Défendre &amp;<br/>Soutenir</h3>
            <p className="font-['DM_Sans'] text-[15px] leading-[1.8] text-white/70 mb-8 text-justify relative">
          ...
          <div className="reveal-right p-[60px_52px]" style={{ background: "linear-gradient(180deg,var(--surface) 0%,var(--surface-2) 100%)" }}>
            ...
            <h3 className="font-['Cormorant_Garamond'] text-[36px] font-semibold text-[--navy] mb-6 leading-[1.2]">Un Accompagnement<br/>Complet</h3>
            <div className="flex flex-col gap-4">
              {["Mutuelle santé & gestion des retraites","Formation et gestion des ressources humaines","Accompagnement au financement bancaire","Gestion comptable & contentieux des impayés","Accès privilégié aux marchés publics","Fonds de solidarité pour les membres"].map(s => (
                <div key={s} className="flex items-start gap-3">
                  ...
                  <span className="font-['DM_Sans'] text-[14px] text-[color:var(--text-muted)] leading-[1.6]">{s}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="reveal text-center mb-16">
          ...
          <h2 className="font-['Cormorant_Garamond'] font-semibold text-[--navy] leading-[1.1]" style={{ fontSize:"clamp(36px,5vw,52px)" }}>
        ...
        <div className="grid grid-cols-4 gap-6 stagger values-grid">
          {VALUES.map(v => (
            <div key={v.title} className="reveal bg-white border border-[--border] border-t-[3px] border-t-[--gold] p-9 rounded-sm transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_20px_60px_rgba(15,23,42,.12)]">
              ...
              <h3 className="font-['Cormorant_Garamond'] text-[22px] font-semibold text-[--navy] mb-3">{v.title}</h3>
              <p className="font-['DM_Sans'] text-[14px] leading-[1.75] text-[#718096] text-justify">{v.desc}</p>
            </div>
          ))}
        </div>
      </div>
